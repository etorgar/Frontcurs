...
//Funcion imprimir carrito-totales
...
templateCarrito.querySelector('td')[2].textContent = items.quantity 
templateCarrito.querySelector('span').textContent = items.subtotal
const clone = templateCard.cloneNode(true)
